...
class Res50Unet():
    ...
    def decoder(self, filters, size, apply_dropout=False):

		initializer = tf.random_normal_initializer(0., 0.02)

		result = tf.keras.Sequential()
		result.add(
			tf.keras.layers.Conv3DTranspose(filters, kernel_size=size, strides=(1,2,2),
										padding='same',
    ...
    def encoder(self, input_shape):
        ...
        return tf.keras.Model(inputs=x_input, outputs=[x, x_skip1, x_skip2, x_skip3, x_skip4], name="encoder")
